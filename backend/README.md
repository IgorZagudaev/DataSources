...
## Иерархическая структура (7 уровней)
...
1. 📋 Доклад (Уровень 1)
   └── N 📁 Разделов доклада (Уровень 2)
       └── N 📝 Справок (Уровень 3)
           ├── N 📑 Блоков справки (Уровень 4) [необязательный]
           │   ├── N 📊 Показателей (Уровень 5)
           │   │   └── N 🔀 Разрезов данных (Уровень 6)
           │   │       └── N 📚 Источников данных (Уровень 7)
           │   └── N 📚 Источников данных (Уровень 5) [прямые источники]
           ├── N 📊 Показателей (Уровень 4)
           │   └── N 🔀 Разрезов данных (Уровень 5)
           │       └── N 📚 Источников данных (Уровень 6)
           └── N 📚 Источников данных (Уровень 4) [прямые источники]
```

**Примечание:** 
- Справка может содержать блоки справки (необязательный уровень), показатели и/или напрямую источники данных
- Блок справки может содержать показатели и/или напрямую источники данных

### Пример структуры:

```
📋 Социально-экономическое развитие региона 2024
   └── 📁 Демография
   ...
   └── 📁 Экономика
       └── 📝 Валовой региональный продукт
           ...
           │       └── 📚 Росстат (форма 1-ВРП)
           └── 📚 Минэкономразвития (прямой источник)
```
...
Поддерживает:
- Создание/редактирование/удаление всех 6 уровней иерархии
...
| POST | /api/noteSources | Создать источник в справке |
| PUT | /api/noteSources/{id} | Обновить источник в справке |
| DELETE | /api/noteSources/{id} | Удалить источник в справке |
