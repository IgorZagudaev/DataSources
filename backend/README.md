...
## Иерархическая структура (6 уровней)
...
1. 📋 Доклад (Уровень 1)
   └── N 📁 Разделов доклада (Уровень 2)
       └── N 📝 Справок (Уровень 3)
           ...
           └── N 📚 Источников данных (Уровень 6) [альтернативная ветка]
```

**Примечание:** Справка может содержать как показатели (полная иерархия), так и напрямую источники данных (сокращённая иерархия).
