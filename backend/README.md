...
Поддерживает:
- Создание/редактирование/удаление всех 7 уровней иерархии
- Экспорт/импорт данных в JSON
- Навигация по дереву
- Просмотр деталей элементов
- Фильтрация и подсветка источников по типу
- Кнопка управления деревом (развернуть/свернуть всё)

#### Кнопка управления деревом

В левой панели под фильтром "Подсветить источники" расположена кнопка-переключатель:
- **▼ Развернуть всё** — раскрывает все узлы дерева (доклады, разделы, справки, блоки, показатели, разрезы)
- **▶ Свернуть всё** — сворачивает все узлы дерева

Кнопка автоматически меняет текст в зависимости от текущего состояния дерева.

#### Изменение порядка элементов

Для каждого элемента иерархии доступны кнопки **↑** (переместить вверх) и **↓** (переместить вниз), которые позволяют изменять порядок следования элементов на одном уровне:
- Доклады можно перемещать между собой
- Разделы можно перемещать внутри доклада
- Справки можно перемещать внутри раздела
- Блоки справки можно перемещать внутри справки
- Показатели можно перемещать внутри справки или блока справки
- Разрезы можно перемещать внутри показателя
- Источники можно перемещать внутри разреза или справки

Кнопки перемещения отображаются фиолетовым цветом и появляются рядом с кнопками редактирования и удаления при наведении на элемент.
